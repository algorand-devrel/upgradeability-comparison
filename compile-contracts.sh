...
tealscript contracts/immutable-v4.algo.ts contracts/artifacts
...
algokitgen generate -a contracts/artifacts/ImmutableV4.json -o contracts/clients/ImmutableV4Client.ts
